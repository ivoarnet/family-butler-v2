...
module.exports = {
  ...
  getDayConfigurationHouseholdId: (...args) => getProvider().getDayConfigurationHouseholdId(...args),
  ...
  replaceDayConfigurations: (...args) => getProvider().replaceDayConfigurations(...args),
